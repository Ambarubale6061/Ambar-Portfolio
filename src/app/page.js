...
export default function Home() {
  return (
    ...
    <div className="min-h-screen bg-white text-gray-900 selection:bg-blue-100 flex flex-col justify-between relative transition-colors duration-300 w-full overflow-x-hidden">
